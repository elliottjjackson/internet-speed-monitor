...
class DataBase:
    ...
    def search_for_id_key(self, header: str, value: Any) -> Optional[int]:
        """Returns database id key when provided a header and value."""
        primary_id_key = None
        return primary_id_key

    def delete_entry_from_id(self, id: int) -> None:
